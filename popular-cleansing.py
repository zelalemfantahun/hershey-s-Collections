...
fileList = glob.glob('/home/zelalem/Downloads/hersheys_archives/PS-extracted/*.txt')
pos_dict = {'JJ': 'a', 'JJR': 'a',
            'JJS': 'a', 'NN': 'n',
            'NNS': 'n', 'NNP': 'n',
            'NNPS': 'n', 'PRP': 'n',
...
for files in fileList:
    ...
    print "writing on a file is stated"
    # file_txt = open("/home/zelalem/Downloads/hersheys_archives/popular-preprocessed/"+path.PurePath(files).parts[6], "w")
    file_txt = open("/home/zelalem/Documents/PS_extracted/" + path.PurePath(files).parts[6], "w")
