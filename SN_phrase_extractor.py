...
file_dict = ('/home/zelalem/Downloads/hersheys_archives/dict/SN_porter_dictionary')
...
fileList = glob.glob('/home/zelalem/Downloads/hersheys_archives/SN_extracted/*.txt') # input file read
# fileList = glob.glob('/home/zelalem/Downloads/hersheys_archives/test2/*.txt')# input file read
error_path ='/home/zelalem/Downloads/hersheys_archives/snextracted_error/' # a folder Containing files with error
# error_path ='/home/zelalem/Downloads/hersheys_archives/snextracted_error_test/' # a folder Containing files with error
# done_file = '/home/zelalem/Downloads/hersheys_archives/SN_extracted_done/'
...
try:
    ...
    for files in fileList:
        ...
        # Used when tokenizing words
            ...
            file_txt = open("/home/zelalem/Downloads/hersheys_archives/SN_Done_phrase/" + path.PurePath(files).parts[6], "w") # a folder containing output
