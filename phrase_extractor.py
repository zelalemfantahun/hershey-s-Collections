...
file_dict = ('/home/zelalem/Downloads/hersheys_archives/dict/PS_test_dictionary')
...
fileList = glob.glob('/home/zelalem/Downloads/hersheys_archives/ps_corrected_test/*.txt')# input file read
error_path ='/home/zelalem/Downloads/hersheys_archives/ps_corrected_error_1/' # a folder Containing files with error
# error_path ='/home/zelalem/Downloads/hersheys_archives/snextracted_error_test/' # a folder Containing files with error
# done_file = '/home/zelalem/Downloads/hersheys_archives/NW_done/'
...
try:
    ...
    for files in fileList:
        ...
        # Used when tokenizing words
            ...
            file_txt = open("/home/zelalem/Downloads/hersheys_archives/PS_Phrase_corrected_1/" + path.PurePath(files).parts[6], "w") # a folder containing output
            # file_txt = open("/home/zelalem/Desktop/PS_Phrase_corrected/" + path.PurePath(files).parts[5], "w") # a folder containing output
